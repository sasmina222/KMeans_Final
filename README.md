...
# Read dataset
data = pd.read_csv(r"C:\Users\sasmi\Downloads\customers_large_dataset.csv")
...
## OUTPUT:
<img width="766" height="634" alt="image" src="https://github.com/user-attachments/assets/9f04b7d1-1fa3-4ad6-9ded-47f3ca8fc892" />
